...
int main() {
    ...
    char* relativeTargetPath = "../../Minimum_Spanning_Tree/UndirectedWeightedGraphs";
    ...
    generateweightedGraphs(currDir,targetDir,actualCurrPath,actualTargetPath);
}